...
class NNIEvaluationEngine {
 public:
  NNIEvaluationEngine(SubsplitDAG &subsplit_dag, SetOfNNIs &set_of_nnis) {
    subsplit_dag_ = subsplit_dag;
    set_of_nnis_ = set_of_nnis;
  }
 ...
 private:
  SubsplitDAG& subsplit_dag_;
  SetOfNNIs& set_of_nnis_;
}

#ifdef DOCTEST_LIBRARY_INCLUDED


TEST_CASE("NNI Evaluation Engine") {
