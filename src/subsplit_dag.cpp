...
const BitsetSizePairMap &SubsplitDAG::ParentToRange() const { return parent_to_range_; }

const std::map<SizePair, size_t> &SubsplitDAG::DAGEdges() const { return dag_edges_; }
